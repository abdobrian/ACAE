...
<li>It does not properly escape arguments with spaces or special characters</li>
</ul>
...
<pre><code class="javascript"><span class="hljs-keyword">var</span> spawn = <span class="hljs-built_in">require</span>(<span class="hljs-string">'cross-spawn'</span>);
