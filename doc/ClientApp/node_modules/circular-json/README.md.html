...
<head>
  ...
  <script>
    var relativeDir = "../../../";
    var thisFile = "ClientApp\\node_modules\\circular-json\\README.md";
...
<p>A quick summary:</p>
<ul>
<li><strong>new</strong> in version <code>0.5</code>, you can specify a JSON parser different from JSON itself. <code>CircularJSON.parser = ABetterJSON;</code> is all you need.</li>
