...
<span class="hljs-keyword">var</span> d              = <span class="hljs-built_in">require</span>(<span class="hljs-string">'d'</span>)
  ...
  , create = <span class="hljs-built_in">Object</span>.create, defineProperties = <span class="hljs-built_in">Object</span>.defineProperties
  , defineProperty = <span class="hljs-built_in">Object</span>.defineProperty, objPrototype = <span class="hljs-built_in">Object</span>.prototype
  , NativeSymbol, SymbolPolyfill, HiddenSymbol, globalSymbols = create(<span class="hljs-literal">null</span>)
  , isNativeSafe;
...
<span class="hljs-keyword">if</span> (<span class="hljs-keyword">typeof</span> <span class="hljs-built_in">Symbol</span> === <span class="hljs-string">'function'</span>) {
	NativeSymbol = <span class="hljs-built_in">Symbol</span>;
...
<span class="hljs-keyword">var</span> generateName = (<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
	<span class="hljs-keyword">var</span> created = create(<span class="hljs-literal">null</span>);
	<span class="hljs-keyword">return</span> <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">desc</span>) </span>{
		<span class="hljs-keyword">var</span> postfix = <span class="hljs-number">0</span>, name, ie11BugWorkaround;
		<span class="hljs-keyword">while</span> (created[desc + (postfix || <span class="hljs-string">''</span>)]) ++postfix;
		desc += (postfix || <span class="hljs-string">''</span>);
		created[desc] = <span class="hljs-literal">true</span>;
		name = <span class="hljs-string">'@@'</span> + desc;
		defineProperty(objPrototype, name, d.gs(<span class="hljs-literal">null</span>, <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">value</span>) </span>{
</pre>
        </td>
      </tr>
...
<p>For IE11 issue see:
https://connect.microsoft.com/IE/feedbackdetail/view/1928508/
ie11-broken-getters-on-dom-objects
https://github.com/medikoo/es6-symbol/issues/12</p>

        </td>
        <td class="code highlight">
          <pre class="javascript">			<span class="hljs-keyword">if</span> (ie11BugWorkaround) <span class="hljs-keyword">return</span>;
			ie11BugWorkaround = <span class="hljs-literal">true</span>;
			defineProperty(<span class="hljs-keyword">this</span>, name, d(value));
			ie11BugWorkaround = <span class="hljs-literal">false</span>;
		}));
...
defineProperties(SymbolPolyfill, {
	<span class="hljs-attr">for</span>: d(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">key</span>) </span>{
		<span class="hljs-keyword">if</span> (globalSymbols[key]) <span class="hljs-keyword">return</span> globalSymbols[key];
		<span class="hljs-keyword">return</span> (globalSymbols[key] = SymbolPolyfill(<span class="hljs-built_in">String</span>(key)));
	}),
	<span class="hljs-attr">keyFor</span>: d(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">s</span>) </span>{
		<span class="hljs-keyword">var</span> key;
		validateSymbol(s);
		<span class="hljs-keyword">for</span> (key <span class="hljs-keyword">in</span> globalSymbols) <span class="hljs-keyword">if</span> (globalSymbols[key] === s) <span class="hljs-keyword">return</span> key;
	}),
...
<p>To ensure proper interoperability with other native functions (e.g. Array.from)
fallback to eventual native implementation of given symbol</p>

        </td>
        <td class="code highlight">
          <pre class="javascript">	hasInstance: d(<span class="hljs-string">''</span>, (NativeSymbol &amp;&amp; NativeSymbol.hasInstance) || SymbolPolyfill(<span class="hljs-string">'hasInstance'</span>)),
	<span class="hljs-attr">isConcatSpreadable</span>: d(<span class="hljs-string">''</span>, (NativeSymbol &amp;&amp; NativeSymbol.isConcatSpreadable) ||
		SymbolPolyfill(<span class="hljs-string">'isConcatSpreadable'</span>)),
	<span class="hljs-attr">iterator</span>: d(<span class="hljs-string">''</span>, (NativeSymbol &amp;&amp; NativeSymbol.iterator) || SymbolPolyfill(<span class="hljs-string">'iterator'</span>)),
	<span class="hljs-attr">match</span>: d(<span class="hljs-string">''</span>, (NativeSymbol &amp;&amp; NativeSymbol.match) || SymbolPolyfill(<span class="hljs-string">'match'</span>)),
	<span class="hljs-attr">replace</span>: d(<span class="hljs-string">''</span>, (NativeSymbol &amp;&amp; NativeSymbol.replace) || SymbolPolyfill(<span class="hljs-string">'replace'</span>)),
	<span class="hljs-attr">search</span>: d(<span class="hljs-string">''</span>, (NativeSymbol &amp;&amp; NativeSymbol.search) || SymbolPolyfill(<span class="hljs-string">'search'</span>)),
	<span class="hljs-attr">species</span>: d(<span class="hljs-string">''</span>, (NativeSymbol &amp;&amp; NativeSymbol.species) || SymbolPolyfill(<span class="hljs-string">'species'</span>)),
	<span class="hljs-attr">split</span>: d(<span class="hljs-string">''</span>, (NativeSymbol &amp;&amp; NativeSymbol.split) || SymbolPolyfill(<span class="hljs-string">'split'</span>)),
	<span class="hljs-attr">toPrimitive</span>: d(<span class="hljs-string">''</span>, (NativeSymbol &amp;&amp; NativeSymbol.toPrimitive) || SymbolPolyfill(<span class="hljs-string">'toPrimitive'</span>)),
	<span class="hljs-attr">toStringTag</span>: d(<span class="hljs-string">''</span>, (NativeSymbol &amp;&amp; NativeSymbol.toStringTag) || SymbolPolyfill(<span class="hljs-string">'toStringTag'</span>)),
	<span class="hljs-attr">unscopables</span>: d(<span class="hljs-string">''</span>, (NativeSymbol &amp;&amp; NativeSymbol.unscopables) || SymbolPolyfill(<span class="hljs-string">'unscopables'</span>))
});
...
defineProperty(SymbolPolyfill.prototype, SymbolPolyfill.toPrimitive, d(<span class="hljs-string">''</span>, <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
...
<p>Proper implementaton of toPrimitive and toStringTag for returned symbol instances</p>
        ...
        <td class="code highlight">
          <pre class="javascript">defineProperty(HiddenSymbol.prototype, SymbolPolyfill.toStringTag,
...
See: https://github.com/medikoo/es6-symbol/issues/13#issuecomment-164146149</p>
        ...
        <td class="code highlight">
          <pre class="javascript">defineProperty(HiddenSymbol.prototype, SymbolPolyfill.toPrimitive,
