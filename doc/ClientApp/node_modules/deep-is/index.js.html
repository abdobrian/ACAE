...
<span class="hljs-keyword">var</span> deepEqual = <span class="hljs-built_in">module</span>.exports = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">actual, expected</span>) </span>{
</pre>
        </td>
      </tr>
...
<p>enforce Object.is +0 !== -0</p>

        </td>
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">if</span> (actual === <span class="hljs-number">0</span> &amp;&amp; expected === <span class="hljs-number">0</span>) {
    <span class="hljs-keyword">return</span> areZerosEqual(actual, expected);
...
<p>7.1. All identical values are equivalent, as determined by ===.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  } <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span> (actual === expected) {
    ...
    <span class="hljs-keyword">return</span> isNumberNaN(expected);
...
equivalence is determined by ==.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  } <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span> (<span class="hljs-keyword">typeof</span> actual != <span class="hljs-string">'object'</span> &amp;&amp; <span class="hljs-keyword">typeof</span> expected != <span class="hljs-string">'object'</span>) {
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">isNumberNaN</span>(<span class="hljs-params">value</span>) </span>{
</pre>
        </td>
      </tr>
...
<p>NaN === NaN -&gt; false</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">return</span> <span class="hljs-keyword">typeof</span> value == <span class="hljs-string">'number'</span> &amp;&amp; value !== value;
}

<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">areZerosEqual</span>(<span class="hljs-params">zeroA, zeroB</span>) </span>{
</pre>
        </td>
      </tr>
...
<p>(1 / +0|0) -&gt; Infinity, but (1 / -0) -&gt; -Infinity and (Infinity !== -Infinity)</p>

        </td>
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">return</span> (<span class="hljs-number">1</span> / zeroA) === (<span class="hljs-number">1</span> / zeroB);
}
