  ...
  <div id="sidebar_wrapper">
    ...
    <div id="headings">
      ...
      <div class="heading h3">
        <a href="#invalid-ranges">Invalid ranges</a>
      </div>
      ...
      <div class="heading h4">
        <a href="#pipe-and-tilde">pipe and tilde</a>
      </div>

      <div class="heading h4">
        <a href="#angle-bracket">angle bracket</a>
      </div>

      <div class="heading h4">
        <a href="#question-mark">question mark</a>
      </div>

      <div class="heading h2">
        <a href="#other-useful-libs">Other useful libs</a>
      </div>
...
fill-range <a href="http://badge.fury.io/js/fill-range"><img src="https://badge.fury.io/js/fill-range.svg" alt="NPM version"></a>  <a href="https://travis-ci.org/jonschlinkert/fill-range"><img src="https://travis-ci.org/jonschlinkert/fill-range.svg" alt="Build Status"></a>
  </h1>
</div>
<blockquote>
...
<pre><code class="bash">npm i fill-range --save
</code></pre>
<!-- toc -->
<ul>
<li><a href="#usage.html">Usage</a>
<ul>
<li><a href="#invalid-ranges.html">Invalid ranges</a></li>
<li><a href="#custom-function.html">Custom function</a></li>
<li><a href="#special-characters.html">Special characters</a>
<ul>
<li><a href="#plus.html">plus</a></li>
<li><a href="#pipe-and-tilde.html">pipe and tilde</a></li>
<li><a href="#angle-bracket.html">angle bracket</a></li>
<li><a href="#question-mark.html">question mark</a></li>
</ul>
</li>
</ul>
</li>
<li><a href="#other-useful-libs.html">Other useful libs</a></li>
...
<pre><code class="js"><span class="hljs-keyword">var</span> range = <span class="hljs-built_in">require</span>(<span class="hljs-string">'fill-range'</span>);

range(<span class="hljs-string">'a'</span>, <span class="hljs-string">'e'</span>);
<span class="hljs-comment">//=&gt; ['a', 'b', 'c', 'd', 'e']</span>
</code></pre>
<p><strong>Params</strong></p>
<pre><code class="js">range(start, stop, step, options, fn);
</code></pre>
<ul>
...
<li><code>fn</code>: <strong>{Function}</strong> optionally <a href="#custom-function.html">pass a function</a> to modify each character</li>
</ul>
<p><strong>Examples</strong></p>
<pre><code class="js">range(<span class="hljs-number">1</span>, <span class="hljs-number">3</span>)
...
<div class="pilwrap" id="invalid-ranges">
  <h3>
    <a href="#invalid-ranges" name="invalid-ranges" class="pilcrow"></a>
Invalid ranges
  </h3>
</div>
<p>When an invalid range is passed, <code>null</code> is returned.</p>
<pre><code class="js">range(<span class="hljs-string">'1.1'</span>, <span class="hljs-string">'2'</span>);
...
<pre><code class="js">range(<span class="hljs-string">'a'</span>, <span class="hljs-string">'e'</span>, <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">val, isNumber, pad, i</span>) </span>{
...
<div class="pilwrap" id="special-characters">
  <h3>
    <a href="#special-characters" name="special-characters" class="pilcrow"></a>
Special characters
  </h3>
</div>
...
<pre><code class="js">range(<span class="hljs-string">'a'</span>, <span class="hljs-string">'z'</span>, SPECIAL_CHARACTER_HERE);
</code></pre>
...
<div class="pilwrap" id="plus">
  <h4>
    <a href="#plus" name="plus" class="pilcrow"></a>
plus
  </h4>
</div>
...
<p><strong>Examples:</strong></p>
<pre><code class="js">range(<span class="hljs-string">'a'</span>, <span class="hljs-number">3</span>, <span class="hljs-string">'+'</span>);
...
<div class="pilwrap" id="pipe-and-tilde">
  <h4>
    <a href="#pipe-and-tilde" name="pipe-and-tilde" class="pilcrow"></a>
pipe and tilde
  </h4>
</div>
...
<p><strong>Examples:</strong></p>
<pre><code class="js">range(<span class="hljs-string">'a'</span>, <span class="hljs-string">'c'</span>, <span class="hljs-string">'|'</span>);
...
<pre><code class="js">range(<span class="hljs-string">'a'</span>, <span class="hljs-string">'z'</span>, <span class="hljs-string">'~5'</span>);
...
<div class="pilwrap" id="angle-bracket">
  <h4>
    <a href="#angle-bracket" name="angle-bracket" class="pilcrow"></a>
angle bracket
  </h4>
</div>
<p>Character: <em>(<code>&gt;</code>)</em></p>
...
<p><strong>Examples:</strong></p>
<pre><code class="js">range(<span class="hljs-string">'a'</span>, <span class="hljs-string">'e'</span>, <span class="hljs-string">'&gt;'</span>);
...
<div class="pilwrap" id="question-mark">
  <h4>
    <a href="#question-mark" name="question-mark" class="pilcrow"></a>
question mark
  </h4>
</div>
<p>Character: <em>(<code>?</code>)</em></p>
...
<pre><code class="js">range(<span class="hljs-string">'A'</span>, <span class="hljs-number">5</span>, <span class="hljs-string">'?'</span>);
<span class="hljs-comment">//=&gt; ['NSHAK']</span>
</code></pre>
<p>Generate a 5-digit random number:</p>
<pre><code class="js">range(<span class="hljs-string">'0'</span>, <span class="hljs-number">5</span>, <span class="hljs-string">'?'</span>);
<span class="hljs-comment">//=&gt; ['36583']</span>
</code></pre>
<p>Generate a 10-character alpha-numeric string:</p>
<pre><code class="js">range(<span class="hljs-string">'A0'</span>, <span class="hljs-number">10</span>, <span class="hljs-string">'?'</span>);
...
<div class="pilwrap" id="other-useful-libs">
  <h2>
    <a href="#other-useful-libs" name="other-useful-libs" class="pilcrow"></a>
Other useful libs
  </h2>
</div>
<ul>
