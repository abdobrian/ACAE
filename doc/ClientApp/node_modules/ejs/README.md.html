...
<body>
  <div id="sidebar_wrapper">
    ...
    <div id="headings">
      ...
      <div class="heading h2">
        <a href="#custom-fileloader">Custom FileLoader</a>
      </div>
...
<pre><code class="javascript"><span class="hljs-keyword">var</span> template = ejs.compile(str, options);
template(data);
...
used in rendering and is <code>.toString()</code>ed in the generation of client functions. (By default escapes XML).</li>
</ul>
...
<pre><code class="javascript"><span class="hljs-keyword">var</span> ejs = <span class="hljs-built_in">require</span>(<span class="hljs-string">'ejs'</span>),
...
of the LRU.</p>
<div class="pilwrap" id="custom-fileloader">
  <h2>
    <a href="#custom-fileloader" name="custom-fileloader" class="pilcrow"></a>
Custom FileLoader
  </h2>
</div>
<p>The default file loader is <code>fs.readFileSync</code>, if you want to customize it, you can set ejs.fileLoader.</p>
<pre><code class="javascript"><span class="hljs-keyword">var</span> ejs = <span class="hljs-built_in">require</span>(<span class="hljs-string">'ejs'</span>);
<span class="hljs-keyword">var</span> myFileLoad = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">filePath</span>) </span>{
...
<span class="hljs-tag">&lt;<span class="hljs-name">script</span>&gt;</span><span class="javascript">
  <span class="hljs-keyword">var</span> people = [<span class="hljs-string">'geddy'</span>, <span class="hljs-string">'neil'</span>, <span class="hljs-string">'alex'</span>],
...
<li>For the same reason, <code>include</code>s do not work unless you use an <code>IncludeCallback</code>. Here is an example:</li>
</ol>
<pre><code class="javascript"><span class="hljs-keyword">var</span> str = <span class="hljs-string">"Hello &lt;%= include('file', {person: 'John'}); %&gt;"</span>,
    fn = ejs.compile(str, {<span class="hljs-attr">client</span>: <span class="hljs-literal">true</span>});

fn(data, <span class="hljs-literal">null</span>, <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">path, d</span>)</span>{ <span class="hljs-comment">// IncludeCallback</span>
