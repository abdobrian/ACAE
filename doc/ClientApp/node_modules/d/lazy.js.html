...
<span class="hljs-keyword">var</span> map        = <span class="hljs-built_in">require</span>(<span class="hljs-string">'es5-ext/object/map'</span>)
  ...
  , cacheDesc = { <span class="hljs-attr">configurable</span>: <span class="hljs-literal">false</span>, <span class="hljs-attr">enumerable</span>: <span class="hljs-literal">false</span>, <span class="hljs-attr">writable</span>: <span class="hljs-literal">false</span>,
...
define = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">name, options</span>) </span>{
	<span class="hljs-keyword">var</span> value, dgs, cacheName, desc, writable = <span class="hljs-literal">false</span>, resolvable
	  , flat;
	options = <span class="hljs-built_in">Object</span>(validValue(options));
	cacheName = options.cacheName;
	flat = options.flat;
	<span class="hljs-keyword">if</span> (cacheName == <span class="hljs-literal">null</span>) cacheName = name;
	...
	dgs = { <span class="hljs-attr">configurable</span>: <span class="hljs-built_in">Boolean</span>(options.configurable),
