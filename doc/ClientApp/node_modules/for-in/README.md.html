...
<pre><code class="sh">$ npm install --save <span class="hljs-keyword">for</span>-in
</code></pre>
...
<pre><code class="js"><span class="hljs-keyword">var</span> forIn = <span class="hljs-built_in">require</span>(<span class="hljs-string">'for-in'</span>);
