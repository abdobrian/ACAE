...
<p>https://es5.github.io/#x8.12</p>

        </td>
        <td class="code highlight">
          <pre class="javascript"><span class="hljs-keyword">var</span> ES5internalSlots = {
	<span class="hljs-string">'[[DefaultValue]]'</span>: <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">O, hint</span>) </span>{
		<span class="hljs-keyword">var</span> actualHint = hint || (toStr.call(O) === <span class="hljs-string">'[object Date]'</span> ? <span class="hljs-built_in">String</span> : <span class="hljs-built_in">Number</span>);
...
<p>https://es5.github.io/#x9</p>
        ...
        <td class="code highlight">
          <pre class="javascript"><span class="hljs-built_in">module</span>.exports = <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">ToPrimitive</span>(<span class="hljs-params">input, PreferredType</span>) </span>{
	<span class="hljs-keyword">if</span> (isPrimitive(input)) {
		<span class="hljs-keyword">return</span> input;
	}
	<span class="hljs-keyword">return</span> ES5internalSlots[<span class="hljs-string">'[[DefaultValue]]'</span>](input, PreferredType);
};
