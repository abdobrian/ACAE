...
<pre><code class="sh">$ npm install --save <span class="hljs-keyword">for</span>-own
</code></pre>
...
<pre><code class="js"><span class="hljs-keyword">var</span> forOwn = <span class="hljs-built_in">require</span>(<span class="hljs-string">'for-own'</span>);
...
forOwn(obj, <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">value, key, o</span>) </span>{
  keys.push(key);
  values.push(value);
});
