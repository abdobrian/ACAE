...
<head>
  ...
  <script>
    var relativeDir = "../../../";
    var thisFile = "ClientApp\\node_modules\\browser-resolve\\index.js";
...
<p>http://nodejs.org/api/modules.html#modules_loading_from_node_modules_folders</p>
        ...
        <span class="hljs-keyword">if</span> (replacements[key] === <span class="hljs-literal">false</span>) {
            val = __dirname + <span class="hljs-string">'/empty.js'</span>;
        }
...
<p>we must always load shims because the browser field could shim out a module</p>
    ...
    <span class="hljs-keyword">if</span> (shims[id]) {
</pre>
        </td>
      </tr>
...
<p>if the shim was is an absolute path, it was fully resolved</p>
        ...
        <td class="code highlight">
          <pre class="javascript">        <span class="hljs-keyword">if</span> (shims[id][<span class="hljs-number">0</span>] === <span class="hljs-string">'/'</span>) {
            <span class="hljs-keyword">return</span> shims[id];
        }
...
<p>module -&gt; alt-module shims</p>
        ...
        <td class="code highlight">
          <pre class="javascript">        id = shims[id];
    }
