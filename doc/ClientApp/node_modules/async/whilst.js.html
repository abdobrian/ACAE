...
<span><ul>
<li>synchronous truth test to perform before each execution of <code>iteratee</code>. Invoked with ().</li>
</ul>
</span>
</div>
<div class="dox_tag_detail">
...
<span class="dox_type">Function</span>
<span><ul>
<li>A callback which is called after the test function has failed and repeated execution of <code>iteratee</code> has stopped. <code>callback</code>
...
callback. Invoked with (err, [results]);</li>
        ...
        <td class="code highlight">
          <pre class="javascript"><span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">whilst</span>(<span class="hljs-params">test, iteratee, callback</span>) </span>{
    ...
    <span class="hljs-keyword">if</span> (!test()) <span class="hljs-keyword">return</span> callback(<span class="hljs-literal">null</span>);
    <span class="hljs-keyword">var</span> next = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">err <span class="hljs-regexp">/*, ...args*/</span></span>) </span>{
        ...
        <span class="hljs-keyword">if</span> (test()) <span class="hljs-keyword">return</span> _iteratee(next);
