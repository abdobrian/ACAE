...
exports.default = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">opts, task</span>) </span>{
    ...
    <span class="hljs-keyword">return</span> (<span class="hljs-number">0</span>, _initialParams2.default)(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">args, callback</span>) </span>{
        <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">taskFn</span>(<span class="hljs-params">cb</span>) </span>{
            _task.apply(<span class="hljs-literal">null</span>, args.concat(cb));
        }

        <span class="hljs-keyword">if</span> (opts) (<span class="hljs-number">0</span>, _retry2.default)(opts, taskFn, callback);<span class="hljs-keyword">else</span> (<span class="hljs-number">0</span>, _retry2.default)(taskFn, callback);
    });
};
...
<div class="dox">
<div class="summary">
<p>A close relative of [<code>retry</code>]{@link module:ControlFlow.retry}.  This method
...
<span class="dox_type">[async.retry]{@link module:ControlFlow.retry}</span>
</div>
...
<span>= {times: 5, interval: 0}| 5] - optional options, exactly the same as from <code>retry</code>
</span>
</div>
<div class="dox_tag_detail">
...
<span><ul>
<li>the asynchronous function to wrap. This function will be passed any arguments passed to the returned wrapper.
Invoked with (...args, callback).</li>
</ul>
</span>
</div>
</div>
