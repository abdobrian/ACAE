...
single-threaded.</p>
<p><strong>Hint:</strong> Use [<code>reflect</code>]{@link module:Utils.reflect} to continue the
...
results from {@link async.parallel}.</p>
</div>
<div class="details">
...
Invoked with (err, results).</li>
        ...
        <td class="code highlight">
          <pre class="javascript"><span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">parallelLimit</span>(<span class="hljs-params">tasks, callback</span>) </span>{
  (<span class="hljs-number">0</span>, _parallel2.default)(_eachOf2.default, tasks, callback);
}
