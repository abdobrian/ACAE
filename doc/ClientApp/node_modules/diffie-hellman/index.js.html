...
<head>
  ...
  <script>
    var relativeDir = "../../../";
    var thisFile = "ClientApp\\node_modules\\diffie-hellman\\index.js";
...
<p>getDiffieHellman</p>

        </td>
        <td class="code highlight">
          <pre class="javascript">exports.DiffieHellmanGroup = crypto.DiffieHellmanGroup
...
<p>createDiffieHellman</p>

        </td>
        <td class="code highlight">
          <pre class="javascript">exports.createDiffieHellman = crypto.createDiffieHellman
